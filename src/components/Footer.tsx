        ...
        <div className="grid grid-cols-2 md:grid-cols-12 gap-x-4 gap-y-8 md:gap-10 mb-8 md:mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <ul className="space-y-2.5 md:space-y-3 text-sm md:text-base font-medium">
              <li><a href="#/" className="hover:opacity-60 transition-opacity">হোম</a></li>
              <li><a href="#/order-track" className="hover:opacity-60 transition-opacity">অর্ডার ট্র্যাক</a></li>
              <li><a href="#/#categories" className="hover:opacity-60 transition-opacity">কলেকশন</a></li>
            </ul>
          </div>
          <div className="col-span-1 md:col-span-2">
            <h4 className="text-xs font-bold uppercase tracking-[0.2em] mb-4 md:mb-5 opacity-60">Categories</h4>
            <ul className="space-y-2.5 md:space-y-3 text-sm md:text-base font-medium">
              {categories && categories.slice(0, 5).map((item, idx) => (
                <li key={item.id || idx}>
