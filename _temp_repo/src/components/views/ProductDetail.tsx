      ...
      {loading ? (
        ...
        <>
                ...
                {!isOutOfStock ? (
                  <div className="space-y-8 pt-4">
                    <div className="flex items-center gap-8">
                      <span className="text-gray-950 font-black uppercase tracking-wider text-sm">পরিমাণ:</span>
                      <div className="flex items-center border-2 border-gray-100 rounded-3xl bg-gray-50 p-1.5 shadow-inner">
                        <button 
                          onClick={() => setQuantity(Math.max(1, quantity - 1))}
                          className="w-12 h-12 flex items-center justify-center hover:bg-white rounded-2xl text-gray-400 hover:text-rose-500 transition-all shadow-sm active:scale-90"
                        >
                        ...
                        <button 
                          ...
                          className="w-12 h-12 flex items-center justify-center hover:bg-white rounded-2xl text-gray-400 hover:text-rose-500 transition-all shadow-sm active:scale-100"
                        >
          ...
          {!isOutOfStock && (
            ...
            >
              <div className="bg-black/90 backdrop-blur-2xl rounded-[15px] p-1.5 shadow-xl flex items-center gap-2 border border-white/10 overflow-hidden">
                <div className="px-3 border-r border-white/10">
                  <div className="flex flex-col font-sans">
                    <span className="text-[8px] font-bold text-white/40 uppercase tracking-widest mb-0.5">সবমোট</span>
                ...
                <button 
                  ...
                  onClick={handleAddToCart}
                  disabled={!isClickable}
                  className="flex-1 bg-white/5 hover:bg-white/10 text-white py-2 rounded-[13px] font-black text-[10px] uppercase tracking-widest flex items-center justify-center transition-all border border-white/5 disabled:opacity-50"
                >
                ...
                <button 
                  ...
                  onClick={handleBuyNow}
                  disabled={!isClickable}
                  className="flex-[1.5] bg-rose-500 text-white py-2 rounded-[13px] font-black text-[11px] uppercase tracking-widest flex items-center justify-center shadow-lg shadow-rose-500/20 active:scale-95 transition-all hover:bg-rose-600 hover:text-white border border-rose-400/40 relative overflow-hidden group disabled:opacity-50"
                >
